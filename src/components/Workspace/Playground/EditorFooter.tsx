		...
		<div className='flex bg-dark-layer-1 bottom-0 w-full'>
			<div className='mx-5 my-[10px] flex justify-between w-full'>
				...
				<div className='ml-auto flex items-center space-x-4'>
					...
					<button
						className='px-3 py-1.5 font-medium items-center transition-all focus:outline-none inline-flex text-sm text-white bg-green-900 hover:bg-green-3 rounded-lg'
						onClick={handleSubmit}
					>
						Submit
					</button>
